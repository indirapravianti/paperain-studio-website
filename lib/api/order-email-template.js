...
const FROM_NAME = process.env.FROM_NAME || 'paperain studio';
const REPLY_TO_EMAIL = process.env.REPLY_TO_EMAIL || 'paperainstudio@gmail.com';
...
<body style="margin: 0; padding: 0; background-color: ${COLORS.bg}; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif;">
  <div style="max-width: 600px; margin: 0 auto; background-color: #ffffff;">
    ...
    <div style="background-color: ${COLORS.pastelBlue}; padding: 32px 40px; text-align: center;">
      ...
      <p style="margin: 8px 0 0; font-size: 13px; color: ${COLORS.primary}; opacity: 0.7;">order confirmation</p>
    </div>
    ...
    <div style="padding: 32px 40px; text-align: center;">
      <p style="margin: 0 0 16px; font-size: 13px; color: #888; line-height: 1.6;">
        ...
        <a href="mailto:${REPLY_TO_EMAIL}" style="color: ${COLORS.primary}; text-decoration: underline;">${REPLY_TO_EMAIL}</a>
      </p>
  ...
  const subject = `order confirmation — ${orderId} ✿ paperain studio`;
...
export { SITE_URL, FROM_EMAIL, REPLY_TO_EMAIL, USD_TO_IDR, fmtIdrFromUsd };
